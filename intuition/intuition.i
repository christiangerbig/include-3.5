...
; ExtNewWindow structure, below.
	RSRESET
NewWindow	rs.b	0
nw_LeftEdge	rs	1 ; initial Window dimensions
nw_TopEdge	rs	1 ; initial Window dimensions
nw_Width	rs	1 ; initial Window dimensions
nw_Height	rs	1 ; initial Window dimensions
nw_DetailPen	rs.b	1 ; for rendering the detail bits of the Window
nw_BlockPen	rs.b	1 ; for rendering the block-fill bits 
nw_IDCMPFlags	rs	2 ; initial IDCMP state
nw_Flags	rs	2 ; see the Flag definition under Window
...
nw_FirstGadget	rs	2
    ...
    ; if this is equal to NULL, you'll get the default imagery
nw_CheckMark	rs	2
nw_Title	rs	2 ; title text for the Window
